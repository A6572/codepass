...
void new_acc()
{
    ...
    account_no:
    system("cls");
    printf("\t\t\t\xB2\xB2\xB2\ ENTER REGISTRATION DETAILS  \xB2\xB2\xB2\xB2");
...
void close(void)
{
    printf("\n\n\n\nTHANKS FOR BANKING WITH ANTHONY GROUP OF BANKS!");
    }
...
{   int choice;
    system("cls");
    system("color 20");
    printf("\n\n\t\t\tSIR ANTHONY BANKS MANAGEMENT SYSTEM");
    printf("\n\n\n\t\t\xB3\xB2\xB2\xB2\xB2\xB2\xB2 WELCOME TO THE MAIN MENU \xB2\xB2\xB2\xB2\xB2\xB2\xB3");
    printf("\n\n\t\t1.New Account\n\t\t2.Update Account\n\t\t3.Transact\n\t\t4.View Account\n\t\t5.Delete Account\n\t\t6.Accounts Report\n\t\t7.Exit\n\n\n\n\n\t\t Enter your choice:");
    scanf("%d",&choice);
    system("cls");
    switch(choice)
...
int main()
{
    ...
    int i=0;
    printf("\n\n\t\tPLEASE ENTER ADMIN PASSWORD TO LOG IN:");
    printf("\n\n\tPassword : ");
    scanf("%s",pass);
    if (strcmp(pass,password)==0)
        ...
        {   printf("\n\n\tYou have Entered Wrong Password!!\a\a\a");
            login_try:
            printf("\n\n\t 1.Try Again\n\t 2.Exit\n\t");
            scanf("%d",&main_exit);
            if (main_exit==1)
